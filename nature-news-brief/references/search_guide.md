# Nature News Brief Retrieval Guide

This document describes how `nature-news-brief` should retrieve, rank, cache, and reuse a shortlist of recent Nature news.

## Scope

Use this guide when `nature-news-brief` needs to prepare a shortlist of recent Nature news summaries for the user.

The skill-level output behavior belongs in [SKILL.md](../SKILL.md). This file covers retrieval, shortlist generation, cache handling, and reuse decisions.
